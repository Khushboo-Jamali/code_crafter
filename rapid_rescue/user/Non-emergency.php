...
if(isset($_POST['submit'])){
    ...
    $driver = $_POST['driver'];
    $query = "INSERT INTO `non-emergency`(`user_name`, `email`, `contact`, `address`, `ambulance_type`, `driver_name`) VALUES ('$name','$email','$contact','$address','$ambulance','$driver')";
    $res = mysqli_query($conn,$query);
    if($res){
        echo "
        <script>
        alert('your request is accepted Ambulance is');
...
?>
        ...
        <div class="container">
            ...
            <h1 class="text-center">Non-Emergency Ambulance</h1>
